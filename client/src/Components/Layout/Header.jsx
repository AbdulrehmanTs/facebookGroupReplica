  ...
  return (
    <header>
        ...
        <div className='relative'>
            ...
            <button className='absolute bottom-[-65px] w-[150px] rounded-[24px] hover:bg-blue-400 transition-all duration-300 cursor-pointer h-[40px] text-[18px]     right-[50px] bg-blue-300 text-white  '> Join Group </button>
        </div>
